...
const contact = () => {
  return (
    <div>
      <div className="w-full md:h-[100vh] text-slate-200 
        ...
        <div className="w-10/12 md:w-3/6 mt-8 mx-auto">
          <form className="">
            <div className="grid gap-6 mb-6 lg:grid-cols-1">
              <div>
                <label htmlFor="name" class="block mb-1 text-sm font-medium ">
                  Enter name :
                </label>
                <input
                  type="text"
            ...
            <div className="flex justify-end">
              <button
                type="submit"
                className=" ] font-bold hover:bg-gray-50 border border-blue-700 hover:border-x-8 hover:text-[#050A30] hover:font-bold rounded-2xl px-2 py-1 mb-3"
              >
                Submit
              </button>
            </div>
